...
export const pageCopy = {
  ...
  fr: {
    home: {
      ...
      nextBody: 'Commencez par un appel stratégique. Nous identifions les points faibles du setup actuel et le prochain mouvement le plus pertinent.',
