...
const plans = [
  ...
  },
  {
    ...
    onetime: {
      price: 1890,
      desc: 'Configuration fee · full system integration included',
      includes: [
        'Full loyalty system architecture and configuration',
  ...
  },
  {
    ...
    summary: 'A calmer scheduling experience that reduces friction, absences, and manual back-and-forth.',
    monthly: {
      price: 79,
      desc: 'Unlimited bookings · reminders and calendar sync',
      includes: [
        'Booking system configuration and optimisation',
    ...
    onetime: {
      price: 690,
      desc: 'Configuration fee · integration and training included',
      includes: [
        'Booking system configuration and optimisation',
        'Calendar sync and rescheduling flows',
  ...
  },
  {
    ...
    summary: 'Structured follow-up that keeps prospects warm, revives past clients, and drives repeat revenue.',
    monthly: {
      price: 119,
    ...
    onetime: {
      price: 990,
      desc: 'Full configuration fee · training and support included',
      includes: [
...
const bundle = {
  ...
  onetime: {
    price: 4490,
    desc: 'Complete delivery fee · full system configuration and handover',
...
const faqs = [
  {
    ...
    a: 'Monthly suits businesses that want a lower entry point with ongoing support included. One-time suits teams that prefer to invest upfront and own the full configuration immediately.',
  },
  {
...
const frPlans = [
  ...
  {
    id: 'wallet-loyalty', num: '02.', title: 'FIDÉLITÉ ORIENTÉE WALLET', summary: 'Une connexion directe à vos clients via Apple et Google Wallet pour renforcer la rétention et le revenu récurrent.',
          ...
          <AnimatedSection delay={0.08}>
            <div className="pricing-bundle-card">
              ...
              <div className="pricing-bundle-grid">
                <div>
                  <p className="pricing-plan-number">{locale === 'fr' ? 'Offre complète' : 'Offre complète'}</p>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="pricing-price-hero">
                      ${bundlePlan.price}
                      {billing === 'monthly' && <span>/mois</span>}
                    </div>
                    <p className="pricing-price-caption">
                      {billing === 'monthly'
                        ? (locale === 'fr' ? 'Pour les entreprises qui veulent un support et des ajustements continus.' : 'For businesses wanting continuous support and refinement.')
